...
public class StripeSubscriptionData {
    ...
    private List<SubscriptionItem> items; // Add this field to store subscription items

    // Add builder pattern for easier construWebGraphQlResponse responsection
    public static StripeSubscriptionData.Builder builder(WebGraphQlResponse response) {
