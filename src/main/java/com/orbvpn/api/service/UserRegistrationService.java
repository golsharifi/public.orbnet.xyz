...
public class UserRegistrationService {
    ...
    public SignupResponse register(UnverifiedUser user) throws MessagingException {
        ...
        if (user.getLanguage() != null) {
            ...
            Locale requestedLocale = new Locale(languageCode);
        ...
        // Use the NotificationService to send the verification email
        notificationService.sendVerificationEmail(user.getEmail(), verificationCode, userLocale);
