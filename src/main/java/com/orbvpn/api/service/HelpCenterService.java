...
import com.orbvpn.api.repository.TicketReplyRepository;
import com.orbvpn.api.repository.TicketRepository;
...
public class HelpCenterService {
  ...
  public List<TicketView> getTicketsByUserId(Integer userId) {
  ...
  public TicketView createTicketForUser(Integer userId, TicketCreate ticketCreate) {
    log.info("Creating ticket for user {} with data {}", userId, ticketCreate);
    ...
    log.info("Created ticket for user {}: {}", userId, ticketView);
