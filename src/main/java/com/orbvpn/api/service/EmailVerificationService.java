...
public class EmailVerificationService {
    ...
    public AuthenticatedUser verifyEmailWithCode(String email, String verificationCode) {
        ...
        Reseller defaultReseller = resellerRepository.getOne(1);
        ...
        // Send a success email to the user using NotificationService instead of
        // NotificationService
        notificationService.sendSuccessVerificationEmail(user.getEmail(), userLocale);
    ...
    public void resendVerificationEmail(String email) {
        ...
        Locale userLocale = unverifiedUser.getLanguage() != null
                ? unverifiedUser.getLanguage()
                : LocaleConfig.DEFAULT_LOCALE;
        // Send the verification email using NotificationService instead of
        // NotificationService
        notificationService.sendVerificationEmail(email, verificationCode, userLocale);
    }
}
