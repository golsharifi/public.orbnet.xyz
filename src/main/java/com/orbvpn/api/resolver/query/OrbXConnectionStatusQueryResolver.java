...
import com.orbvpn.api.service.OrbXSubscriptionValidationService;
import com.orbvpn.api.service.OrbXSubscriptionValidationService.ConnectionStatus;
...
/**
 * GraphQL Query Resolver for OrbX connection status.
 * Allows the app to check if a user can connect before attempting.
 */
@Controller
@Slf4j
@RequiredArgsConstructor
public class OrbXConnectionStatusQueryResolver {

    private final OrbXSubscriptionValidationService validationService;
    ...
    @Secured(USER)
    @QueryMapping
    public Map<String, Object> orbxConnectionStatus() {
        User currentUser = userService.getUser();
        log.debug("User {} checking OrbX connection status", currentUser.getEmail());
