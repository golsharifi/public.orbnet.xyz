...
import com.orbvpn.api.service.OrbXBandwidthValidationService;
import com.orbvpn.api.service.OrbXBandwidthValidationService.BandwidthStatus;
import com.orbvpn.api.service.OrbXBandwidthValidationService.ProtocolBandwidthUsage;
...
public class OrbXBandwidthQueryResolver {

    private final OrbXBandwidthValidationService bandwidthService;
    ...
    @Secured(USER)
    @QueryMapping
    public Map<String, Object> orbxBandwidthStatus() {
    ...
    @Secured(USER)
    @QueryMapping
    public Map<String, Object> orbxProtocolBandwidthUsage(
    ...
    @Secured(USER)
    @QueryMapping
    public List<Map<String, Object>> orbxBandwidthProducts() {
