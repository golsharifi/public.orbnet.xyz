...
public interface OrbXConnectionStatsRepository extends JpaRepository<OrbXConnectionStats, Long> {
    ...
    List<OrbXConnectionStats> findActiveConnectionsByUserId(@Param("userId") Integer userId);
    ...
    @Query("SELECT s FROM OrbXConnectionStats s " +
            ...
            "AND s.disconnectedAt IS NULL " +
            "ORDER BY s.connectedAt ASC")
    List<OrbXConnectionStats> findOldestActiveConnectionByUserId(@Param("userId") Integer userId);
    ...
    @Query("SELECT s FROM OrbXConnectionStats s " +
            ...
            "ORDER BY s.connectedAt DESC")
    List<OrbXConnectionStats> findAllActiveConnections();
